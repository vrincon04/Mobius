<div class="block-header">
    <h2><i class="material-icons">add</i> <?php echo lang('new'); ?> - <?php echo lang('users') ?></h2>
</div>
<!-- Vertical Layout -->
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="username" name="username" class="form-control" value="<?php echo set_value('username'); ?>" placeholder="<?php echo lang('username'); ?>" autofocus required data-rule-alphanumeric="true" minlength="2" maxlength="60" />
                        </div>
                    </div>
