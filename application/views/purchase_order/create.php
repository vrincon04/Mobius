<div class="block-header">
    <h2><i class="material-icons">add</i> <?php echo lang('new'); ?> - <?php echo lang('purchase_order') ?></h2>
</div>
<!-- Vertical Layout -->
        ...
        <form id="purchase_order-form" method="post" enctype="multipart/form-data" data-validator="true" class="form-validate">
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <?php echo form_dropdown('warehouse_id', $warehouses, set_value('warehouse_id'), 'id="warehouse_id" class="form-control show-tick" required') ?>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" id="expected_at" name="expected_at" class="form-control input-datepicker" value="<?php echo strftime("%d %B %Y"); ?>" placeholder="<?php echo lang('enter_expected_at'); ?>" required datepickerGreaterThan='{"dateStart" : "#date", "dateEnd" : "#expected_at"}' />
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        <?php echo ucwords(lang('purchase_information')); ?>
                        <small>Los campos marcodo con <span class="text-danger">*</span> son requerido.</small>
                    </h2>
                </div>
