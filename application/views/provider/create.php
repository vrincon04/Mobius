<div class="block-header">
    <h2><i class="material-icons">add</i> <?php echo lang('new'); ?> - <?php echo lang('provider') ?></h2>
</div>
<!-- Vertical Layout -->
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form id="provider-form" method="post" enctype="multipart/form-data" class="form-validate">
            <div class="card">
                <div class="header">
                    <h2>
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="document_number" name="document_number" class="form-control" value="<?php echo set_value('document_number'); ?>" placeholder="<?php echo lang('enter_document_number'); ?>" required minlength="2" maxlength="100" />
                        </div>
                    </div>
