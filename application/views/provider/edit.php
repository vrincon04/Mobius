<div class="block-header">
    <h2><i class="material-icons">edit</i> <?php echo lang('edit'); ?> - <?php echo lang('provider') ?></h2>
</div>
<!-- Vertical Layout -->
        ...
        <form id="provider-form" method="post" enctype="multipart/form-data" class="form-validate">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="email" id="email" name="email" class="form-control" value="<?php echo set_value('email', $provider->email); ?>" placeholder="<?php echo lang('enter_email'); ?>" required data-rule-email="true" maxlength="260" />
                        </div>
                    </div>
