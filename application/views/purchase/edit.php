<div class="block-header">
    <h2><i class="material-icons">edit</i> <?php echo lang('edit'); ?> - <?php echo lang('purchase') ?></h2>
</div>
<!-- Vertical Layout -->
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form id="purchase-form" method="post" enctype="multipart/form-data" data-validator="true" class="form-validate">
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <?php echo form_dropdown('currency_id', $currencies, set_value('currency_id', $purchase->currency_id), 'id="currency_id" data-live-search="true" class="form-control show-tick" required') ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            <?php foreach($expirations_types as $type): ?>
                                <option value="<?php echo $type->id; ?>" data-value="<?php echo $type->value; ?>" <?php echo ($type->id == $purchase->expiration_type_id) ? 'selected' : '' ?>><?php echo lang($type->lang); ?></option>
                            <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line" id="bs_datepicker_container">
                            <input type="text" id="date" name="date" class="form-control input-datepicker" value="<?php echo strftime("%d %B %Y", strtotime(set_value('date', $purchase->date))); ?>" placeholder="<?php echo lang('enter_date'); ?>" required />
                        </div>
                    </div>

                    <label for="expired_at"><?php echo lang('expired_at'); ?> <span class="text-danger">*</span> </label>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons" style="font-size: 30px;">date_range</i>
                        </span>
                        <div class="form-line">
                            <input type="text" id="expired_at" name="expired_at" class="form-control input-datepicker" value="<?php echo strftime("%d %B %Y", strtotime(set_value('date', $purchase->expired_at))); ?>" placeholder="<?php echo lang('enter_expired_at'); ?>" required datepickerGreaterThan='{"dateStart" : "#date", "dateEnd" : "#expired_at"}' />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <textarea rows="1" name="annotations" id="annotations" class="form-control no-resize auto-growth" placeholder="<?php echo lang('enter_annotations'); ?>"><?php echo set_value('annotations', $purchase->annotations); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="body table-responsive">
                    ...
                    <a href="<?php echo base_url('purchase'); ?>" class="btn btn-danger waves-effetc m-r-10">
